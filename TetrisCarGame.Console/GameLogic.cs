...
namespace TetrisCarGame
{
    class GameLogic
    {
        ...
        public GameLogic(int widthInAuto, int heightInAuto, double machinesAtOneLine,/* double enemySpeed,*/ int playerSpeed, int loopDelay)
        {
        ...
        void OnGameFinish()
        {
            Console.WriteLine("\nYou lose. Restart?(y,n)");
            string str=Console.ReadLine();
            if (!string.IsNullOrEmpty(str) && str.IndexOf('y')>=0)
            {
                StartGame();
            }
        }
